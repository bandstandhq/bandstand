...
export const invites = pgTable(
  'invites',
  {
    ...
    // INVITE_CODE_LENGTH chars from a confusion-resistant alphabet (no
    // 0/O/1/I/l), generated by application code — see packages/core's
    // generateInviteCode (added alongside the real redemption endpoint).
    // Plain `text`, not `varchar(n)`, specifically so a future length
    // change (like the 6→8 one this comment itself survived) never needs
    // a migration to widen a column.
